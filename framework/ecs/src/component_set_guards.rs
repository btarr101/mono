...
//     fn get_lock_from_world(world: &World) -> Arc<RwLock<ComponentSet<T>>> { world.component_set_lock::<T>() }
...
//     fn get_lock_from_world(world: &World) -> Arc<RwLock<ComponentSet<T>>> { world.component_set_lock() }
//     fn lock(lock: Arc<RwLock<ComponentSet<T>>>) -> Self {
