...
- ~~Infinite lists for browse and ratings page~~
- ~~When a rating is edited, the order shall not change~~
- ~~Share Button~~
- ~~Discord oauth~~
...
- Community Page
  - ~SCROLL RESTO SCROLLRESTO SCROLL RESTO AHHHHH FIX THE TINY RESTO BUG WHEN GOING BACK FROM CARD PAGE~
- ~About Page~ For now...
