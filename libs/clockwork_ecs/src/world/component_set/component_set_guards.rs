//! Guard types for component set locks.
...
/// Shared guard that provides read-only access to a component set.
...
/// Shared guard that provides exclusive access to a component set.
